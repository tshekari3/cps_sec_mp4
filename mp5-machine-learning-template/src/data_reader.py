...
class DataReader:
    ...
    ALL_FEATURE_LIST = ['Pd_bus1', 'Qd_bus1', 'Pd_bus2', 'Qd_bus2', 'Pd_bus3', 'Qd_bus3', 'Pd_bus4',
                        ...
                        'Pg_gen1', 'Qg_gen1', 'Pg_gen2', 'Qg_gen2', 'Pg_gen3', 'Qg_gen3', 'Pg_gen4', 'Qg_gen4', 'Pg_gen5', 'Qg_gen5', 'Pg_gen6', 'Qg_gen6',
    ...
    def load_train_data(self) -> None:
        ...
        """
        self._load_data()
        self.selected_feature_columns = self._find_important_features(df_feature=self.features_df, df_labels=self.labels_df)
        ...
        assert all(item in DataReader.ALL_FEATURE_LIST for item in self.selected_feature_columns), "Not all elements of selected_columns are in ALL_FEATURE_LIST"
